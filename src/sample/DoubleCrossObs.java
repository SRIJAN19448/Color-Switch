...
public class DoubleCrossObs extends Obstacle{
    ...
    public void rotateL(Line line, int number){
        ...
        if(number==0) {
            ...
            line.setEndX(100+ length * Math.cos(Math.toRadians(degree1[3])));
    ...
    public void rotateR(Line line, int number){
        ...
        if(number==4) {
            ...
            line.setEndX(200+ length * Math.cos(Math.toRadians(degree2[3])));
