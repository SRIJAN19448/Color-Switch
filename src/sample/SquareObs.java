...
public class SquareObs extends Obstacle{
    ...
    public void rotateX(Line line, int number){
        ...
        if(number==0) {
            ...
            line.setEndY(250- length * Math.sin(Math.toRadians(degree[0]+90)));
        }
        else if(number==1) {
            ...
            line.setEndY(250- length * Math.sin(Math.toRadians(degree[1]+90)));
            ...
            line.setEndY(250- length * Math.sin(Math.toRadians(degree[2]+90)));
            ...
            line.setStartY(250- length * Math.sin(Math.toRadians(degree[3])));
            line.setEndX(150+ length * Math.cos(Math.toRadians(degree[3]+90)));
            line.setEndY(250- length * Math.sin(Math.toRadians(degree[3]+90)));
